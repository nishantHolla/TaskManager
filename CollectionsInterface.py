...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_7.setText(
            _translate("MainWindow", "Open the Selected Collection")
        )
        self.pushButton_7.clicked.connect(self.connect_collection)
        self.pushButton_7.clicked.connect(self.connect_to_todo)

    def connect_to_todo(self):
        path = os.getcwd() + "/env/bin/python"
        os.execv(path, [path, "To_Do_Interface_with_Time.py"])
