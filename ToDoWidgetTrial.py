...
# Adding items onto the list
    ...
    def retranslateUi(self, Form):
        ...
        self.label_4.setText(_translate("Form", "Tasks"))
        self.pushButton.setText(_translate("Form", "Add a task "))
        self.pushButton.clicked.connect(self.add_item)
        self.pushButton_4.setText(_translate("Form", "Delete Task "))
        self.pushButton_4.clicked.connect(self.delete_item)
        self.pushButton_5.setText(_translate("Form", "Clear All tasks"))
